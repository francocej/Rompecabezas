...
var instrucciones = ["1-Recordar el orden.", "2-Presionar Jugar.", "3-Ordenar las piezas.", "A jugar!!"];
// Arreglo para ir guardando los movimientos que se vayan realizando
var movimientos = [];
var eligioDificultad = false;
...
function comprobarDificultad(dificultad){
  if (eligioDificultad == false) {
    mezclarPiezas(dificultad);
    eligioDificultad = true;
  } else { alert ("Ya elegiste dificultad. Debes terminar este juego o apretar f5")}
}
...
function chequearSiGano() {
  ...
  var grillaJugador = grilla.join();
  if (win == grillaJugador) {
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var ubicacion = grilla[filaPos1][columnaPos1];
  var destino = grilla[filaPos2][columnaPos2];
  grilla[filaPos1][columnaPos1] = destino;
  grilla[filaPos2][columnaPos2] = ubicacion;
}
...
function moverEnDireccion(direccion, chequeo) {
...
/* EDIT : Ahora se inicia cuando el jugador elige la dificultad.
